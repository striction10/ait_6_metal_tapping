...
{
    public class PotGroupHistoryRepository : GenericRepository<PotGroupsHistory, PotGroupsHistoryModel>, IPotGroupHistoryRepository
    {
        private readonly AppDbContext _context;
        private readonly IMapper _mapper;

        public PotGroupHistoryRepository(AppDbContext context, IMapper mapper)
            : base(context, mapper)
        {
            _context = context;
            _mapper = mapper;
