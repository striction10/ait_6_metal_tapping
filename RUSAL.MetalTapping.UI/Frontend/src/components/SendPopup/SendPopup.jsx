...
function SendPopup({ isOpen, onClose, pageType, selectedDate }) {
    ...
    if (sendStatus === 'success') {
        return (
            <div className="sp-overlay" onClick={handleOverlayClick} onKeyDown={handleKeyDown} role="dialog" aria-modal="true">
                <div className="sp-card sp-card-success">
                    <div className="sp-success">
                        ...
                        <h3>Отправлено!</h3>
                        <p>Файл успешно отправлен на <strong>{email}</strong></p>
                    </div>
                </div>
            </div>
        )
                    ...
                    <div className="sp-field">
                        ...
                        {selectedFile ? (
                            <div className="sp-file-selected">
                                ...
                                <button className="sp-file-remove" onClick={() => { setSelectedFile(null); if (document.getElementById('sp-file-input')) document.getElementById('sp-file-input').value = '' }} aria-label="Удалить файл">
