    ...
    IMapper mapper)
{
    ...
    {
        var entity = EnsureFound(await _metalMarkAnalysisRepository.GetMetalMarkAnalysisWithPotIdAsync(potId),
    ...
    {
        var entities = await _metalMarkAnalysisRepository.GetMetalMarkAnalysisWithPotIdsAsync(potIds);
